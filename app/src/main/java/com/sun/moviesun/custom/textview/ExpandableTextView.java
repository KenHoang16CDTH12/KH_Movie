package com.sun.moviesun.custom.textview;
...
public class ExpandableTextView extends LinearLayout implements View.OnClickListener {
  ...
  @IdRes
  private int mExpandableTextId = R.id.textExpandable;

  @IdRes
  private int mExpandCollapseToggleId = R.id.imageExpandCollapse;
  ...
  private void init(AttributeSet attrs) {
    ...
    mExpandableTextId = typedArray.getResourceId(R.styleable.ExpandableTextView_expandableTextId, R.id.textExpandable);
    mExpandCollapseToggleId = typedArray.getResourceId(R.styleable.ExpandableTextView_expandCollapseToggleId, R.id.imageExpandCollapse);
    ...
    switch (expandToggleType) {
      case EXPAND_INDICATOR_IMAGE_BUTTON:
        ...
        if (expandDrawable == null) {
          expandDrawable = getDrawable(context, R.drawable.ic_keyboard_arrow_down_white_24dp);
        }
        if (collapseDrawable == null) {
          collapseDrawable = getDrawable(context, R.drawable.ic_keyboard_arrow_up_white_24dp);
        }

...
public class ImageAutoAnimation extends ImageView {
  ...
  public ImageAutoAnimation(Context context) {
    this(context, null);
  }

  public ImageAutoAnimation(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public ImageAutoAnimation(Context context, AttributeSet attrs, int defStyle) {
  ...
  public void setTransitionListener(ImageAutoAnimation.TransitionListener transitionListener) {
